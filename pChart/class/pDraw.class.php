   ...
   function drawScale($Format="")
    {
     ...
     $Factors		= isset($Format["Factors"]) ? $Format["Factors"] : array(1,2,4);
             ...
             for($i=0;$i<=$Parameters["Rows"];$i++)
              {
			   ...
			   $Bounds  = $this->drawText($XPos-$OuterTickWidth-2,$YPos,intval($Value),array("Align"=>TEXT_ALIGN_MIDDLERIGHT));
               //////////////////
